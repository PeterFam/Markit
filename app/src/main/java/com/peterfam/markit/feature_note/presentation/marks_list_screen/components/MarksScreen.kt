...
fun MarksScreen(
    ...
    viewModel: MarkItViewModel = hiltViewModel()
){
    ...
    Scaffold(floatingActionButton = {
        ...
        Column(modifier = Modifier
            ...
            Row(
                ...
                IconButton(onClick = {
                    viewModel.onEvent(MarkItEvent.ToggleOrderSection)
                }) {
            ...
            AnimatedVisibility(
                ...
                OrderSection(
                    ...
                    markOrder = state.marksOrder,
                    onOrderChanged = {
                        viewModel.onEvent(MarkItEvent.Order(it))
                    })
            }
                        ...
                        scope.launch {
                          val result =  scaffoldState.snackbarHostState.showSnackbar(
                            ...
                            if(result == SnackbarResult.ActionPerformed){
                                viewModel.onEvent(MarkItEvent.RestoreMark)
                            }
                        }
                    })
                    Spacer(modifier = Modifier.height(16.dp))
